<template>
  <div class="my-content">
    ...
    <!-- 提示框 -->
    <el-alert title="注意：只允许为第三级设置相关参数！" class="my-warning" type="warning" show-icon></el-alert>
    <el-row class="my-category">
      <el-col :span="24">
        <el-cascader
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="动态参数" name="first">
        <el-button disabled class="my-btn" type="primary">添加动态参数</el-button>
        <!-- 表格 -->
        <el-table :data="parList" border style="width: 100%">
          ...
          <el-table-column prop="username" label="操作" width="180"></el-table-column>
          <el-table-column prop="mobile" label="操作" width="180">
            <template slot-scope>
              <el-button size="mini" type="primary" plain icon="el-icon-edit" circle></el-button>
